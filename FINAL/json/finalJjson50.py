...
# Setting up logging
logging.basicConfig(filename='spark_imdb_self_join50_performance.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
# Execute each query 10 times (10 epochs)
...
sample_variance = math.sqrt((sample_variance_squared_value - (10 * (mean_resp_time ** 2)))/9)

plus_minus_num = 2.2622*(sample_variance)/math.sqrt(10)
