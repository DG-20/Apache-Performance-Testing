...
# Setting up logging
logging.basicConfig(filename='spark_imdb_self_join10_performance.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
# Execute each query 2 times (2 epochs)
