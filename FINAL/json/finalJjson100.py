...
# Setting up logging
logging.basicConfig(filename='spark_imdb_self_join100_performance.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
# Execute each query 20 times (20 epochs)
