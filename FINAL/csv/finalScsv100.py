...
# Setting up logging
logging.basicConfig(filename='spark_select100_performance.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
# Execute each query 10 times (1 epochs)
