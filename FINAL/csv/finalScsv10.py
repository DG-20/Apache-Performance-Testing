...
# Setting up logging
logging.basicConfig(filename='spark_select10_performance.log', level=logging.INFO, format='%(asctime)s:%(levelname)s:%(message)s')
...
# Execute each query 1 time (1 epoch)
